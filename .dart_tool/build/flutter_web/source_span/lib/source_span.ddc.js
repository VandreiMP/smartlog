define(['dart_sdk', 'packages/path/path', 'packages/term_glyph/src/generated/ascii_glyph_set'], function(dart_sdk, packages__path__path, packages__term_glyph__src__generated__ascii_glyph_set) {
  ...
  var _span$ = dart.privateName(highlighter, "_span");
  var _color$ = dart.privateName(highlighter, "_color");
  var _multiline = dart.privateName(highlighter, "_multiline");
  var _paddingBeforeSidebar = dart.privateName(highlighter, "_paddingBeforeSidebar");
  var _paddingAfterSidebar = dart.privateName(highlighter, "_paddingAfterSidebar");
  var _writeSidebar = dart.privateName(highlighter, "_writeSidebar");
  var _writeText = dart.privateName(highlighter, "_writeText");
  var _writeFirstLine = dart.privateName(highlighter, "_writeFirstLine");
  var _writeIntermediateLines = dart.privateName(highlighter, "_writeIntermediateLines");
  var _writeLastLine = dart.privateName(highlighter, "_writeLastLine");
  var _writeTrailingLines = dart.privateName(highlighter, "_writeTrailingLines");
  ...
  var _span$0 = dart.privateName(span_exception, "_span");
  ...
  var _source$ = dart.privateName(span_exception, "_source");
