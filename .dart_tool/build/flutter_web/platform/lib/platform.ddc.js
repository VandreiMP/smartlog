define(['dart_sdk'], function(dart_sdk) {
  ...
  var $_get = dartx._get;
  var LinkedHashMapOfString$String = () => (LinkedHashMapOfString$String = dart.constFn(collection.LinkedHashMap$(core.String, core.String)))();
  ...
  var numberOfProcessors$ = dart.privateName(fake_platform, "FakePlatform.numberOfProcessors");
  var pathSeparator$ = dart.privateName(fake_platform, "FakePlatform.pathSeparator");
  var operatingSystem$ = dart.privateName(fake_platform, "FakePlatform.operatingSystem");
  var operatingSystemVersion$ = dart.privateName(fake_platform, "FakePlatform.operatingSystemVersion");
  var localHostname$ = dart.privateName(fake_platform, "FakePlatform.localHostname");
  var environment$ = dart.privateName(fake_platform, "FakePlatform.environment");
  var executable$ = dart.privateName(fake_platform, "FakePlatform.executable");
  var resolvedExecutable$ = dart.privateName(fake_platform, "FakePlatform.resolvedExecutable");
  var script$ = dart.privateName(fake_platform, "FakePlatform.script");
  var executableArguments$ = dart.privateName(fake_platform, "FakePlatform.executableArguments");
  var packageRoot$ = dart.privateName(fake_platform, "FakePlatform.packageRoot");
  var packageConfig$ = dart.privateName(fake_platform, "FakePlatform.packageConfig");
  var version$ = dart.privateName(fake_platform, "FakePlatform.version");
  var stdinSupportsAnsi$ = dart.privateName(fake_platform, "FakePlatform.stdinSupportsAnsi");
  var stdoutSupportsAnsi$ = dart.privateName(fake_platform, "FakePlatform.stdoutSupportsAnsi");
  var localeName$ = dart.privateName(fake_platform, "FakePlatform.localeName");
