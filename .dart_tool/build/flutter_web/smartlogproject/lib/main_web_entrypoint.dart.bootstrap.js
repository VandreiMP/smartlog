...
let modulePaths = {
 ...
 "packages/path_provider_platform_interface/path_provider_platform_interface": "packages/path_provider_platform_interface/path_provider_platform_interface.ddc",
 ...
 "packages/smartlogproject/Components/body": "packages/smartlogproject/Components/body.ddc",
 "packages/smartlogproject/Components/login": "packages/smartlogproject/Components/login.ddc",
 "packages/smartlogproject/Components/menu/itemMenu": "packages/smartlogproject/Components/menu/itemMenu.ddc",
 "packages/smartlogproject/Components/menu/menu": "packages/smartlogproject/Components/menu/menu.ddc",
 "packages/smartlogproject/main": "packages/smartlogproject/main.ddc",
 "packages/smartlogproject/main_web_entrypoint": "packages/smartlogproject/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/smartlogproject/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:smartlogproject/main_web_entrypoint.dart") {
          // Clear static caches.
