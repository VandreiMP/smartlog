define(['dart_sdk', 'packages/smartlogproject/main'], function(dart_sdk, packages__smartlogproject__main) {
  'use strict';
  ...
  const main = packages__smartlogproject__main.main;
  ...
  dart.trackLibraries("packages/smartlogproject/main_web_entrypoint", {
    "package:smartlogproject/main_web_entrypoint.dart": main_web_entrypoint
  }, {
