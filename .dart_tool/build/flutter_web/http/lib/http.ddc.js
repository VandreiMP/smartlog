define(['dart_sdk', 'packages/http/src/base_client', 'packages/http_parser/http_parser'], function(dart_sdk, packages__http__src__base_client, packages__http_parser__http_parser) {
  ...
  var FutureOfResponse = () => (FutureOfResponse = dart.constFn(async.Future$(response.Response)))();
  var ClientToFutureOfResponse = () => (ClientToFutureOfResponse = dart.constFn(dart.fnType(FutureOfResponse(), [client$.Client])))();
  var FutureOfString = () => (FutureOfString = dart.constFn(async.Future$(core.String)))();
  var ClientToFutureOfString = () => (ClientToFutureOfString = dart.constFn(dart.fnType(FutureOfString(), [client$.Client])))();
  var FutureOfUint8List = () => (FutureOfUint8List = dart.constFn(async.Future$(typed_data.Uint8List)))();
  var ClientToFutureOfUint8List = () => (ClientToFutureOfUint8List = dart.constFn(dart.fnType(FutureOfUint8List(), [client$.Client])))();
  ...
  var JSArrayOfMultipartFile = () => (JSArrayOfMultipartFile = dart.constFn(_interceptors.JSArray$(multipart_file.MultipartFile)))();
  var StringAndStringToNull = () => (StringAndStringToNull = dart.constFn(dart.fnType(core.Null, [core.String, core.String])))();
  var _AsyncStarImplOfListOfint = () => (_AsyncStarImplOfListOfint = dart.constFn(async._AsyncStarImpl$(ListOfint())))();
