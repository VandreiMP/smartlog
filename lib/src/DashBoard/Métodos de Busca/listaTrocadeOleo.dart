...
class DashBoardTrocadeOleo extends StatefulWidget {
  @override
  _DashBoardTrocadeOleoState createState() => _DashBoardTrocadeOleoState();
}

class _DashBoardTrocadeOleoState extends State<DashBoardTrocadeOleo> {
  @override
                                    ...
                                    itemBuilder:
                                      ...
                                      return Container(
                                        child: situacao == 'Aberta'
                                            ...
                                            //                   .only(top: 2),
                                            //           child: Text(
                                            //             'Você não possui nenhuma programação em aberto para troca de óleo.',
                                            //             style: TextStyle(
                                            //                 fontWeight:
                                            //                     FontWeight
                                            //                         .bold,
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(
                              'Você não possui nenhuma programação para troca de óleo registrada no sistema.',
                              style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 15,
                                  color: Colors.red),
