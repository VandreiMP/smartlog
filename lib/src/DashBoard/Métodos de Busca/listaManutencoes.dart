...
class DashBoardManutencao extends StatefulWidget {
  @override
  _DashBoardManutencaoState createState() => _DashBoardManutencaoState();
}

class _DashBoardManutencaoState extends State<DashBoardManutencao> {
  @override
                                    ...
                                    itemBuilder:
                                      ...
                                      return Container(
                                        child: situacao == 'Aberta'
                                            ...
                                            //                       .only(top: 2),
                                            //               child: Text(
                                            //                 'Você não possui nenhuma programação em aberto para manutenção.',
                                            //                 style: TextStyle(
                                            //                     fontWeight:
                                            //                         FontWeight
                                            //                             .bold,
