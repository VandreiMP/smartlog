...
class ScreenTrocaOleo extends StatelessWidget {
...
class CriaCardFormulario extends StatelessWidget {
  ...
  */
  ...
  final tPrecoOleo = TextEditingController();
  final tQuantidadeOleo = TextEditingController();
  final tPrecoUnitarioFiltro = TextEditingController();
  final tQuantidadeFiltro = TextEditingController();
